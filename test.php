...
<body>
  ...
  <script type="text/javascript">
    var data = {
      placementid: '222415438250477_222416241583730',
      format: 'native',
      testmode: false,
      onAdLoaded: function(element) {
        console.log('Audience Network [222415438250477_222416241583730] ad loaded');
        element.style.display = 'block';
      },
      onAdError: function(errorCode, errorMessage) {
        console.log('Audience Network [222415438250477_222416241583730] error (' + errorCode + ') ' + errorMessage);
      }
    };
  </script>
  <script>
